  ...
  useEffect(() => {
    async function callOpenAIAPI() {
      const APIBody = {
        ...
        prompt:
          "Your task is to use your incredible rationale to guess the word being described. Your answer must only be one word long. The correct answer will never be a plural. The answer will never include any word used in the description. The description is: '" +
          description +
          "'. What word do you think this is? Sometimes the description will invite you to finish a sentence, by ending the description with a '_'. If the description is incomprehensible, simply respond 'what was that?'",
        temperature: 0,
        max_tokens: 500,
        top_p: 1.0,
